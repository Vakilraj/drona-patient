...
import {
	...
	View,
	Text,
	StatusBar, Image, TextInput, TouchableOpacity, ActivityIndicator, BackHandler, FlatList, ScrollView, Platform
} from 'react-native';
							...
							<ScrollView>
								<View style={{ flex: 1, flexDirection: 'column' }}>
									<View style={{ width: '100%', backgroundColor: Color.primaryBlue, borderTopLeftRadius: 7, borderTopRightRadius: 7, }}>
										<Text style={{ fontFamily: CustomFont.fontName, fontSize: CustomFont.font24, color: Color.white, marginTop: 15, marginBottom: 15, marginLeft: 15 }}>{this.state.showHeaderDate}</Text>
									</View>
									...
									<Calendar
										theme={{
											...
											todayTextColor: Color.optiontext,
