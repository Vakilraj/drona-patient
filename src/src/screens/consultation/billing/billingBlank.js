...
class BillingHistory extends React.Component {
    ...
    renderItem = (item, index) => {
        ...
        return (
            <TouchableOpacity onPress={() => { this.props.navigation.navigate("NewBill", { item: item}) }} style={{ marginTop: 2, backgroundColor: Color.white, flexDirection: 'row', paddingBottom: 8, paddingTop: 8, borderRadius: responsiveWidth(1.5), marginLeft: responsiveWidth(3), marginRight: responsiveWidth(3) }}>
