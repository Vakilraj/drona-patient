...
const styles = StyleSheet.create({
  ...
  selectedView: { flexDirection: 'row', margin: responsiveWidth(1.6), height: responsiveWidth(10), borderRadius: 5, borderWidth:.7, justifyContent: 'center', alignItems: 'center', backgroundColor: Color.selectedBgSymptom,borderColor:Color.primary  },
